...
export default function Home() {
  return (
    <main className="flex justify-center items-center h-screen bg-black text-white relative">
      <div className="flex justify-center items-center flex-col gap-7 bg-black text-white absolute top-32 max-w-[900px]">
      <WordPullUp className="text-3xl md:text-5xl lg:text-7xl text-center font-bold" words="Understand Complex Documents Easily & Effortlessly." />
